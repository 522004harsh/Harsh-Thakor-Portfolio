  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          className={`aspect-[16/10] ${image ? (containImage ? (customBg ? '' : 'bg-gradient-to-br from-teal-100 via-teal-50 to-teal-200/50') : '') : `bg-gradient-to-br ${gradient}`} relative overflow-hidden flex items-center justify-center`}
